...
public class JSONService {
	...
	@Path("/bynamelist")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getListOfAllEmployeesByName(@QueryParam("name") String name)
	{
        	PersistenceManager pm = pmf.getPersistenceManager();
        	...
        	try {
        		...
        		Query q = pm.newQuery(Employee.class, "employee_Name == \"" +name+ "\"");
        	   ...
        	   // return Response.status(Response.Status.OK.getStatusCode()).entity(name).build();
	...
	@GET
	@Path("/bydesignationlist")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getListOfAllEmployeesByDesignation(@QueryParam("designation") String name)
	{
        	PersistenceManager pm = pmf.getPersistenceManager();
        	...
        	try {
        		...
        		Query q = pm.newQuery(Employee.class, "employee_Designation == \"" +name+ "\"");
	...
	@Path("/bysalarylist")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getListOfAllEmployeesBySalary(@QueryParam("min") double min,@QueryParam("max") double max )
	{
        	PersistenceManager pm = pmf.getPersistenceManager();
        	...
        	try {
        		...
        		Query q = pm.newQuery(Employee.class, "employee_Salary >= "+min  + "&& employee_Salary <= "+max  );
