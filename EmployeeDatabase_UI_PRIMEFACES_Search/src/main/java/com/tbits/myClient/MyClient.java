...
import com.tbits.common.EmployeeBean;
...
public class MyClient {
	...
	//	 ListOfAllEmployee();
		ListOfAllEmployeeByNameUI("Dfd") ; 
		break;
	    default:
		System.out.println("Incorrect Choice. Re-enter your choice otherwise input (0) for Exit");
   ...
   public List<Employee> ListOfAllEmployeeUI () 
   {
	...
	WebResource webResource = client
		.resource("http://localhost:8080/JavaServerFacesEmployeeDatabase/rest/json/metallica/list");
	...
	return response.getEntity(new GenericType<List<Employee>>() {});
	
	
   }


   public static List<Employee> ListOfAllEmployeeByNameUI (String searchName) 
   {
	...
	WebResource webResource = client
			.resource("http://localhost:8080/JavaServerFacesEmployeeDatabase/rest/json/metallica/bynamelist?name="+searchName);
	...
	List<Employee> emp = response.getEntity(new GenericType<List<Employee>>() {});
	/*Iterator<Employee> iter = emp.iterator(); 
	
	System.out.println("Response from server.... "+ iter.hasNext());
	while (iter.hasNext())
	{
   ...
   public static List<Employee> ListOfAllEmployeeByDesignationUI (String searchdesignation) 
   {
	...
	WebResource webResource = client
			.resource("http://localhost:8080/JavaServerFacesEmployeeDatabase/rest/json/metallica/bydesignationlist?designation="+searchdesignation);
...
*/	
   ...
   public static List<Employee> ListOfAllEmployeeBySalaryUI (final double min , final double max ) 
   {
	...
	WebResource webResource = client
			.resource("http://localhost:8080/JavaServerFacesEmployeeDatabase/rest/json/metallica/bysalarylist?min="+min +"&max="+max);
