...
public class MyClient {
	...
	WebResource webResource = client
		.resource("http://localhost:8080/jersey/rest/json/metallica/add");
	...
	WebResource webResource = client
		.resource("http://localhost:8080/jersey/rest/json/metallica/update?id="+temp_id);
	...
	// Create Web resources
	WebResource webResource = client
			.resource("http://localhost:8080/jersey/rest/json/metallica/get?id="+temp_id);
	...
	// Create Web resources
	WebResource webResource = client
			.resource("http://localhost:8080/jersey/rest/json/metallica/delete?id="+temp_id);
    ...
    private static void  ListOfAllEmployee () throws Exception
    {
	// read id for update
	...
	WebResource webResource = client
		.resource("http://localhost:8080/jersey/rest/json/metallica/list");
